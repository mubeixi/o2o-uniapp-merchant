        ...
        <div class="store-item" v-for="(store,idx) in storeFavoriteList" :key="idx">
          ...
          <div class="flex1 box">
            ...
            <div class="content p-10 c8">
              <div class="fz-14 ">电话：0371-8888888<layout-icon size="18" class="p-l-10" weight="bold" color="#26C78D" display="inline" type="iconicon-phone"></layout-icon></div>
              <div class="m-t-18 fz-14 ">地址：河南省郑州市金水区文化路东风路交叉口向南 500米路西硅谷商务广场A座2208室<layout-icon size="18" class="p-l-10" weight="bold" type="iconicon-address"  display="inline" color="#26C78D"></layout-icon></div>
            </div>
          </div>
