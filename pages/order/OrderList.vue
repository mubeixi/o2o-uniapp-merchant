<template>
	...
	<!--					<div class="attr" v-else style="background-color: #FFFFFF;"><span></span></div>-->
						<div class="pro-price"><span>￥</span>100 <span class="amount">x5</span></div>
					</div>
				</div>
			</block>
			<div class="text-right total">共1件商品 实付：<span class="price"><span>￥</span> 100 <block >(含运费{{10}元)</block></span></div>
			<div class="btn-group" >
