...
import DiyGroup from '@/components/diy-group/diy-group'
import DiyTab from '@/components/diy-tab/diy-tab'
import DiyCube from '@/components/diy-cube/diy-cube'
import DiyCoupon from '@/components/diy-coupon/diy-coupon'
import DiyNotice from '@/components/diy-notice/diy-notice'
import DiySearch from '@/components/diy-search/diy-search'
import DiySpace from '@/components/diy-space/diy-space'
import DiyHr from '@/components/diy-hr/diy-hr'
import DiyVideo from '@/components/diy-video/diy-video'
import DiySwiper from '@/components/diy-swiper/diy-swiper'
import DiyBase from '@/components/diy-base/diy-base'
import DiyGoods from '@/components/diy-goods/diy-goods'
import DiyKill from '@/components/diy-kill/diy-kill'
import DiyTitle from '@/components/diy-title/diy-title'
import DiyText from '@/components/diy-text/diy-text'
import { getDiySkinConfig } from '@/api/common'
