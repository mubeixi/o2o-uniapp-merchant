    ...
    <view :key="item" @click="readMsg(item,index)" class="centers" v-for="(item,index) of pro">
      <view class="tops">
        ...
        <view class="view">
          ...
          <layout-icon class="image zhan" size="16" type="iconicon-arrow-right" v-else-if="item.isShow"></layout-icon>
          <layout-icon class="image shou" size="16" type="iconicon-arrow-top" v-else></layout-icon>
        </view>
      </view>
      <view class="times">
