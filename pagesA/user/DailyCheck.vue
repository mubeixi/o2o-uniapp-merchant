  ...
  <view @click="commonClick" class="all" v-if="pro">
    ...
    <view class="top">
      <view @click="signinMethod" class="yuan">
        <image :src="'/static/client/qiandao.png'|domain" class="image"></image>
        <layout-icon class="qiandao" color="#f43939" size="22" type="iconedit"></layout-icon>
    ...
    <view class="jilu">
      <view :key="index" class="chang" v-for="(item,index) in continue_">
        <image :src="'/static/client/checked.png'|domain" class="image" v-if="index<continues"></image>
        <image :src="'/static/client/unchecked.png'|domain" class="image" v-else></image>
        <view class="view">
          第{{index+1}}天
        </view>
      </view>
    ...
    <view class="err">
      <layout-icon color="#ff0000" size="16" type="iconerror"></layout-icon>
      温馨提示
    </view>
