        ...
        <div class="fz-14 container">
          <swiper class="swiper-box" :current="currentSwiperIndex">
            <swiper-item class="swiper-item">
              ...
              >
                <LayoutIcon type="iconradio-check" color="#F53636" class="m-r-5"
                            v-if="selectIdxList[0] === index"></LayoutIcon>
                {{item.area_name}}
              </div>
            </swiper-item>
            <swiper-item class="swiper-item">
              ...
              >
                <LayoutIcon type="iconradio-check" color="#F53636" class="m-r-5"
                            v-if="selectIdxList[1] === index"></LayoutIcon>
                {{item.area_name}}
              </div>
            </swiper-item>
            <swiper-item class="swiper-item">
              ...
              >
                <LayoutIcon type="iconradio-check" color="#F53636" class="m-r-5"
                            v-if="selectIdxList[2] === index"></LayoutIcon>
                {{item.area_name}}
              </div>
            </swiper-item>
            <swiper-item class="swiper-item" v-if="visiable">
              ...
              >
                <LayoutIcon type="iconradio-check" color="#F53636" class="m-r-5"
                            v-if="selectIdxList[3] === index"></LayoutIcon>
                {{item.area_name}}
              </div>
            </swiper-item>
          </swiper>
